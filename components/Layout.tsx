...
import { LayoutDashboard, FileText, Package, PieChart, ShieldCheck, Users, Briefcase, Factory, Search, LogOut } from 'lucide-react';
  ...
  return (
    <div className="flex h-screen bg-slate-50/50 overflow-hidden">
      ...
      <main className="flex-1 h-full flex flex-col overflow-hidden bg-[#F8FAFC]">
        ...
        {/* Content Area */}
        <div className="flex-1 overflow-y-auto pt-[150px] md:pt-0 custom-scrollbar">
            <div className="p-4 md:p-6 max-w-[1920px] mx-auto space-y-6 animate-fade-in pb-20 md:pb-8">
                {children}
            </div>
        </div>
      </main>
